    ...
    <section class="smart-scroll">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-md navbar-dark">
                <a class="navbar-brand heading-black" href="{{route('inicio')}}">
                    Fern
                </a>
        ...
        <div class="container">
            <div class="row vh-md-100">
                <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
                    <h1 class="heading-black text-capitalize">Soluciones Empresariales</h1>
                    <p class="lead py-3">Trabajamos para optmimzar tus procesos</p>
            ...
            <div class="row mt-6">
                ...
                <div class="col-md-5">
                    <div class="slick-about">
                        <img src="{{asset('images/blog-1.jpg')}}" class="img-fluid rounded d-block mx-auto" alt="Work 1" />
                        <img src="{{asset('images/blog-2.jpg')}}" class="img-fluid rounded d-block mx-auto" alt="Work 2" />
                        <img src="{{asset('images/blog-3.jpg')}}" class="img-fluid rounded d-block mx-auto" alt="Work 3" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{asset('images/blog-1.jpg')}}" alt="Blog 1">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{asset('images/blog-2.jpg')}}" alt="Blog 2">
                        </a>
                        <div class="card-body">
                            <a href="#" class="card-title mb-2">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{asset('images/blog-3.jpg')}}" alt="Blog 3">
                        </a>
                        <div class="card-body">
                            <a href="#" class="card-title mb-2">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-12 text-muted text-center small-xl">
                    &copy; {{now()->year()}} fern - Todos los derechos Reservados
                </div>
            </div>
        </div>
    </footer>
